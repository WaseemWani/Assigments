...
class ProfileViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        nameLabel.text = "Waseem Wani" //UserDefaults.standard.string(forKey: AppConstants.nameKey)
        emailLabel.text = "waseemwani@gmail.com" //UserDefaults.standard.string(forKey: AppConstants.emailKey)
        idLabel.text = "1234" //UserDefaults.standard.string(forKey: AppConstants.idKey)
        roleLabel.text = "Employee" // UserDefaults.standard.string(forKey: AppConstants.roleKey)
    }
}
