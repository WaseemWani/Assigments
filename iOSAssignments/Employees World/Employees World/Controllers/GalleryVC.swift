...
class GalleryVC: UIViewController, UISearchBarDelegate {
    ...
    var itemCount = 10
    var query = "Mango"
    var googleImages = [GoogleImages]() // array to store images recieved from google api
    ...
    override func viewDidLoad() {
        ...
        if isMainGalleryVc == false && isSubGalleryVC == false {
            ...
            //savedImages = UserDefaults.standard.array(forKey: "galleryImages") as! [String]
            ...
            case .sucess(let response) :
                ...
                for images in googleImages {
                    for item in images.items!{
                        ...
                        self.thumbNailLink.append((item.imageDetails?.thumbnailLink)!)
                    }
                }
...
extension GalleryVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, CustomizedView {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        if isMainGalleryVc {
            ...
            return imageCount
            //UserDefaults.standard.array(forKey: "galleryImages")?.count
            ...
            return imageLink.count  // here, return count of images for currently selected employee
        }
    }
        ...
        if isMainGalleryVc {
            ...
            if let url = URL(string: fetchedThumbNails?[indexPath.row].thumbnailURL ?? "") {
                ...
                UIImage.loadFrom(url: url, completion: { image in
                    ...
                    //show images from images array...later from database
                })
            }
            return cell
        } else if isSubGalleryVC {
...
extension GalleryVC: UISearchControllerDelegate {
    ...
    func searchBarTextDidEndEditing(_ searchBar: UISearchBar) {
        self.query =  searchBar.text?.replacingOccurrences(of: " ", with: "%20") ?? "mango"
